...
class DA(object):
    ...
    def __init__(self, source_data_dir, target_data_dir):

        # source / target image root
        self.source_images_dir = source_data_dir
        self.target_images_dir = target_data_dir
        # training image dir
        ...
        self.target_num_cam = self.cam_dict['market']
        self.source_num_cam = self.cam_dict['duke']
